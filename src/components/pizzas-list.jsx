...
export function PizzasList() {
    ...
    const {chunk, currentPage, setCurrentPage, pagesAmount} = usePagination(pizzas, 4)
    ...
    return(
        <>
            ...
            <Pagination count={pagesAmount} page={currentPage} onChange={(event, value) => {setCurrentPage(value)}} className="pagination"/>
        </>
    )
}